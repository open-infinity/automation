class oi4idp::config {
  ...
  $authn_LDAP_useStartTLS=hiera('toas::idp::authn_LDAP_useStartTLS', "TODO")
  $authn_LDAP_useSSL=hiera('toas::idp::authn_LDAP_useSSL', "TODO")
  $authn_LDAP_trustCertificates=hiera('toas::idp::authn_LDAP_trustCertificates', "TODO")
  $authn_LDAP_trustStore=hiera('toas::idp::authn_LDAP_trustStore', "TODO")
  $authn_LDAP_returnAttributes=hiera('toas::idp::authn_LDAP_returnAttributes', "TODO")
  $authn_LDAP_baseDN=hiera('toas::idp::authn_LDAP_baseDN', "TODO")
  $authn_LDAP_userFilter=hiera('toas::idp::authn_LDAP_userFilter', "TODO")
  $authn_LDAP_bindDN=hiera('toas::idp::authn_LDAP_bindDN', "TODO")
  $authn_LDAP_bindDNCredential=hiera('toas::idp::authn_LDAP_bindDNCredential', "TODO")
  $authn_LDAP_dnFormat=hiera('toas::idp::authn_LDAP_dnFormat', "TODO")
  $authn_LDAP_ldapURL=hiera('toas::idp::authn_LDAP_ldapURL', "TODO")
  $authn_LDAP_groupBaseDN=hiera('toas::idp::authn_LDAP_groupBaseDN', "TODO")
  ...
  file { "/opt/openinfinity/log/tomcat":
    ...
    group  => "oiuser",
    mode   => 755,
  } ->file { "/opt/openinfinity/scripts/init-tomcat.sh":
    ensure => present,
    owner  => 'oiuser',
    group  => 'oiuser',
    mode   => 0700,
  ...
  exec { "init-tomcat-for-idp":
    command => "/opt/openinfinity/scripts/init-tomcat.sh",
  } ->
